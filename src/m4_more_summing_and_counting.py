...
def run_test_count_cosines_from():
    ...
    # Test 3:
    expected = 4
    answer = count_cosines_from(-4, 2, .35)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 7
    answer = count_cosines_from(-10, 0, 0.-.45)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 3
    answer = count_cosines_from(7, 12, -.14)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 4
    answer = count_cosines_from(15, 24, .26)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 0.25129
    answer = sum_unit_fractions_from(25, 31)
